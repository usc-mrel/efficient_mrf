...
% this line modifies the desired trajectory FOV to be simply a step-wise 
% function rather than a polynomial
%if r > 1, F = 24; else F = 3.2*24; end % need to be modified!
% if (r < 10/256 * rmax)
%     F = 100;
% else
%     F = 30;
