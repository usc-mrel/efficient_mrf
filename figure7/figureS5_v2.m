...
fS5_v2 = figure('Position', [200 160 925 605], 'Color', 'k', 'InvertHardcopy', 'off');
...
window_y = [76*ones(1, 30) 76:125, 125*ones(1, 30) 125:-1:76];
...
%% T1 maps.
fS5_t1_v2 = figure('Position', [200 160 925 605], 'Color', 'k', 'InvertHardcopy', 'off');
[ha, pos] = tight_subplot(2, 3, [0 0], [0 0], [0.03 0.03]);
ha = (reshape(ha, [3 2])).';
...
%% T2 maps.
fS5_t2_v2 = figure('Position', [200 160 925 605], 'Color', 'k', 'InvertHardcopy', 'off');
[ha, pos] = tight_subplot(2, 3, [0 0], [0 0], [0.03 0.03]);
ha = (reshape(ha, [3 2])).';
...
%% Save figures.
saveas(fS5_v2, 'figureS5_v2.fig');
saveas(fS5_v2, 'figureS5_v2.png');
saveas(fS5_t1_v2, 'figureS5_t1_v2.fig');
saveas(fS5_t1_v2, 'figureS5_t1_v2.png');
saveas(fS5_t2_v2, 'figureS5_t2_v2.fig');
saveas(fS5_t2_v2, 'figureS5_t2_v2.png');
