...
f7 = figure('Position', [200 160 925 605], 'Color', 'k', 'InvertHardcopy', 'off');
[ha, pos] = tight_subplot(2, 3, [0 0], [0 0], [0.03 0.03]);
ha = (reshape(ha, [3 2])).';

xrange = 111:140;
yrange = 151:200;
window_x = [111:140 140*ones(1, 50) 140:-1:111 111*ones(1, 50)];
...
%% T1 maps.
f7_t1 = figure('Position', [200 160 925 605], 'Color', 'k', 'InvertHardcopy', 'off');
[ha, pos] = tight_subplot(2, 3, [0 0], [0 0], [0.03 0.03]);
ha = (reshape(ha, [3 2])).';
...
%% T2 maps.
f7_t2 = figure('Position', [200 160 925 605], 'Color', 'k', 'InvertHardcopy', 'off');
[ha, pos] = tight_subplot(2, 3, [0 0], [0 0], [0.03 0.03]);
ha = (reshape(ha, [3 2])).';
...
%% Save figures.
saveas(f7, 'figure7.fig');
saveas(f7, 'figure7.png');
saveas(f7_t1, 'figure7_t1.fig');
saveas(f7_t1, 'figure7_t1.png');
saveas(f7_t2, 'figure7_t2.fig');
saveas(f7_t2, 'figure7_t2.png');
